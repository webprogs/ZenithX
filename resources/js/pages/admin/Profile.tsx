...
import { getProfile, updateProfile, changePassword, AdminProfile } from '@/api/admin/profile';
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        ...
        <p className="text-[#707a8a]">Manage your administrator account</p>
      </div>
        ...
        <Card>
          <div className="flex items-center">
            <div className="p-2 sm:p-3 rounded-lg bg-[#fef6d8]">
              <CalendarIcon className="w-5 h-5 sm:w-6 sm:h-6 text-[#f0b90b]" />
            </div>
            <div className="ml-3 sm:ml-4">
              <p className="text-xs sm:text-sm text-[#707a8a]">Account Created</p>
              <p className="text-sm sm:text-base font-medium text-[#1e2329]">
        ...
        <Card>
          <div className="flex items-center">
            <div className="p-2 sm:p-3 rounded-lg bg-[#e6f4ff]">
              <ClockIcon className="w-5 h-5 sm:w-6 sm:h-6 text-[#0070f3]" />
            </div>
            <div className="ml-3 sm:ml-4">
              <p className="text-xs sm:text-sm text-[#707a8a]">Last Login</p>
              <p className="text-sm sm:text-base font-medium text-[#1e2329]">
        ...
        <Card>
          ...
          <form onSubmit={passwordForm.handleSubmit(handleChangePassword)} className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-[#b7b9bc]">Minimum 8 characters</p>
            </div>
